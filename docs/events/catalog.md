...
| `article.block.reviewed`          | article    | yes            | `resource_id`, `resource_type=article_block`, `block_id`, `status=reviewed / unreviewed`                                                           | `datahub.projections`                                          |
...
| `progress.evaluation.completed`   | progress   | yes            | `resource_id`, `resource_type=progress_evaluation`, `status=succeeded`, detected/effective stage, summary and counts                               | `datahub.projections`, `notification.progress-evaluations`     |
...
| `experiment.settings.updated`     | experiment | yes            | `resource_id`, `resource_type=experiment_settings`, timezone, default Runtime policy, default limits, Git large-file threshold                     | none                                                           |
