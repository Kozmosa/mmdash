...
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/heartbeat`                                                                                          | `box.heartbeat`                            | box control          | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/users/me/boxes/{boxId}`                                                                                           | `box.personal.get`                         | box control          | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/users/me/boxes`                                                                                                   | `box.personal.list`                        | box control          | `core.yaml`                   |
| Core        | HTTP          | `PATCH`       | `/v1/users/me/boxes/{boxId}`                                                                                           | `box.personal.update`                      | box control          | `core.yaml`                   |
| Core        | HTTP          | `PUT`         | `/v1/projects/{projectId}/boxes/{boxId}`                                                                               | `box.project.assign`                       | box control          | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/boxes`                                                                                       | `box.project.list`                         | box control          | `core.yaml`                   |
| Core        | HTTP          | `DELETE`      | `/v1/projects/{projectId}/boxes/{boxId}`                                                                               | `box.project.remove`                       | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes`                                                                                                            | `box.register`                             | box control          | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/box/releases`                                                                                                     | `box.releases.list`                        | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/users/me/boxes/{boxId}/revoke`                                                                                    | `box.revoke`                               | box control          | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/box-source-transfers/{token}`                                                                                     | `box.source.download`                      | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/{taskId}/artifact`                                                                            | `box.tasks.artifact.upload`                | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/claim`                                                                                        | `box.tasks.claim`                          | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/{taskId}/logs`                                                                                | `box.tasks.logs.append_batch`              | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/{taskId}/result`                                                                              | `box.tasks.result`                         | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/{taskId}/resume`                                                                              | `box.tasks.resume`                         | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/boxes/{boxId}/tasks/{taskId}/status`                                                                              | `box.tasks.status`                         | box control          | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments/{experimentId}/archive`                                                          | `experiment.archive`                       | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments/{experimentId}/cancel`                                                           | `experiment.cancel`                        | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/experiments/compare`                                                                         | `experiment.compare`                       | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments`                                                                                 | `experiment.create`                        | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/experiments/{experimentId}`                                                                  | `experiment.get`                           | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/experiments`                                                                                 | `experiment.list`                          | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/experiments/{experimentId}/logs`                                                             | `experiment.logs.list`                     | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments/{experimentId}/rerun`                                                            | `experiment.rerun`                         | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments/{experimentId}/result/bind`                                                      | `experiment.result.bind`                   | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/internal/experiment-result-jobs/{jobId}/finalize`                                                                 | `experiment.result_jobs.finalize`          | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/internal/experiment-result-jobs/{jobId}/input`                                                                    | `experiment.result_jobs.input.get`         | experiment           | `core.yaml`                   |
| Core        | HTTP          | `POST`        | `/v1/projects/{projectId}/experiments/{experimentId}/run`                                                              | `experiment.run`                           | experiment           | `core.yaml`                   |
| Core        | HTTP          | `GET`         | `/v1/projects/{projectId}/experiments/settings`                                                                        | `experiment.settings.get`                  | experiment           | `core.yaml`                   |
| Core        | HTTP          | `PATCH`       | `/v1/projects/{projectId}/experiments/settings`                                                                        | `experiment.settings.update`               | experiment           | `core.yaml`                   |
| Web BFF     | HTTP          | `GET`         | `/api/users/me/boxes/{boxId}`                                                                                          | `bff.box.personal.get`                     | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/users/me/boxes`                                                                                                  | `bff.box.personal.list`                    | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `PATCH`       | `/api/users/me/boxes/{boxId}`                                                                                          | `bff.box.personal.update`                  | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `PUT`         | `/api/projects/{projectId}/boxes/{boxId}`                                                                              | `bff.box.project.assign`                   | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/boxes`                                                                                      | `bff.box.project.list`                     | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `DELETE`      | `/api/projects/{projectId}/boxes/{boxId}`                                                                              | `bff.box.project.remove`                   | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/box/releases`                                                                                                    | `bff.box.releases.list`                    | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/users/me/boxes/{boxId}/revoke`                                                                                   | `bff.box.revoke`                           | box control          | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments/{experimentId}/archive`                                                         | `bff.experiment.archive`                   | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments/{experimentId}/cancel`                                                          | `bff.experiment.cancel`                    | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments/compare`                                                                        | `bff.experiment.compare`                   | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments`                                                                                | `bff.experiment.create`                    | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments/{experimentId}`                                                                 | `bff.experiment.get`                       | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments`                                                                                | `bff.experiment.list`                      | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments/{experimentId}/logs`                                                            | `bff.experiment.logs.list`                 | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments/{experimentId}/logs/stream`                                                     | `bff.experiment.logs.stream`               | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments/{experimentId}/rerun`                                                           | `bff.experiment.rerun`                     | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments/{experimentId}/result/bind`                                                     | `bff.experiment.result.bind`               | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `POST`        | `/api/projects/{projectId}/experiments/{experimentId}/run`                                                             | `bff.experiment.run`                       | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `GET`         | `/api/projects/{projectId}/experiments/settings`                                                                       | `bff.experiment.settings.get`              | experiment           | `web-bff.yaml`                |
| Web BFF     | HTTP          | `PATCH`       | `/api/projects/{projectId}/experiments/settings`                                                                       | `bff.experiment.settings.update`           | experiment           | `web-bff.yaml`                |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `experiment.create`                        | experiment           | `experiment.create.json`      |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `experiment.run`                           | experiment           | `experiment.run.json`         |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `experiment.status`                        | experiment           | `experiment.status.json`      |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `experiment.settings`                      | experiment           | `experiment.settings.json`    |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `experiment.result.bind`                   | experiment           | `experiment.result.bind.json` |
| MCP Gateway | MCP Tool      | `tools/call`  | `/mcp`                                                                                                                 | `result.get`                               | experiment           | `result.get.json`             |
