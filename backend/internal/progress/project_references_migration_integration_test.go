...
func TestProgressHumanWorkbenchMigrationFreshUpDownUp(t *testing.T) {
	...
	execProgressMigration(t, ctx, connection, "000033_progress_human_workbench.up.sql")
	...
	execProgressMigration(t, ctx, connection, "000033_progress_human_workbench.down.sql")
