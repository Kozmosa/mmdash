...
import { Check, Circle, CircleCheckBig, CircleDotDashed, LoaderCircle, OctagonAlert, X } from "lucide-react";
...
export function ProgressItemCard({ canManage, className, compact = false, item, kind, onOpen, onReview, onToggle, pendingCompletion }: Readonly<Props>) {
